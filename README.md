# The VoxTube Dataset [![VoxTube on Hugginface](https://huggingface.co/datasets/huggingface/badges/raw/main/dataset-on-hf-xl.svg)](https://huggingface.co/datasets/voice-is-cool/voxtube)
